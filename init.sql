...
('admin', 'Administrator', 'Full access to all features', '{
    ...
    "vm:view": true, "vm:create": true, "vm:update": true, "vm:delete": true, "vm:start": true, "vm:stop": true, "vm:restart": true, "vm:console": true, "vm:migrate": true, "vm:execute": true, "vm:manage": true,
    ...
    "user:view": true, "user:create": true, "user:update": true, "user:delete": true, "user:manage": true,
