...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      // A `render` prop replaces the underlying <button> (e.g. with a Link/<a>),
      // so it's no longer a native button — tell Base UI to apply the button
      // role + keyboard semantics instead. Explicit nativeButton always wins.
